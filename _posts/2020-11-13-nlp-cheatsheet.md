...
- ###### [Maieutic Prompting: Logically Consistent Reasoning with Recursive Explanations](https://aclanthology.org/2022.emnlp-main.82.pdf) (Jung et al., EMNLP 2022): 
    ...
    ![](/assets/img/vldb/maieutic.png){:style="width: 50%; display:block; margin-left:auto; margin-right:auto"}
    *(source: copied from the paper).*
...
#### <b>4. Tools-Augmented Language Model </b>

<b>2023</b>

- ###### [Toolformer: Language Models Can Teach Themselves to Use Tools](https://arxiv.org/pdf/2302.04761.pdf) (Schick et al., arxiv 2023)

    <b>Toolformer</b>, a fine-tuned LM, is capable of deciding when to call APIS, which APIs to call, what arguments to pass, how to leverage API's results in next token prediction.

    ![](/assets/img/cheatsheet/toolformer_0.png){:style="width: 30%; display:block; margin-left:auto; margin-right:auto"}
    ...
    (a) ![](/assets/img/cheatsheet/toolformer_1.png){:style="width: 30%"} (b) ![](/assets/img/cheatsheet/toolformer_2.png){:style="width: 65%"}
...
- ###### [I2D2: Inductive Knowledge Distillation with NeuroLogic and Self-Imitation](https://arxiv.org/pdf/2212.09246.pdf) (Bhagavatula et al.): 
    ...
    ![](/assets/img/vldb/i2d2.png){:style="width: 60%; display:block; margin-left:auto; margin-right:auto"} *(source: copied from the paper).*
    *(source: copied from the paper).*

- ###### [Symbolic Knowledge Distillation: from General Language Models to Commonsense Models](https://aclanthology.org/2022.naacl-main.341.pdf) (West et al., NAACL 2022)
    ...
    ![](/assets/img/vldb/distill.png){:style="width: 30%; display:block; margin-left:auto; margin-right:auto"} *(source: copied from the paper).*
